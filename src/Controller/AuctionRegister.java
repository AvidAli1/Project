...
public class AuctionRegister {
    ...
    public static void main(String[] args) {
    	...
    	manager.getAllItems(); // return item list
    	manager.getItem("1234"); //return item with ID
    	auctionManager.addAuction("A123", LocalDate.of(2024, 12, 25), 100); //adds an auction
    	auctionManager.getAuctionList(); //returns all auctions
